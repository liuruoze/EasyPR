...
int saveTrainData()
{
    ...
    string path = (string)projectpath+"train/data/chars_recognise_ann/chars2";
    ...
    path = (string)projectpath+"train/data/chars_recognise_ann/charsChinese";
    ...
    FileStorage fs((string)projectpath+"train/ann_data.xml", FileStorage::WRITE);
...
{
    FileStorage fs;
    fs.open((string)projectpath+"train/ann_data.xml", FileStorage::READ);
