...
namespace easypr{
    ...
    void learn2HasPlate(float bound = 0.7)
    {
       ...
       string filePath =(string)projectpath+"train/data/plate_detect_svm/learn/HasPlate";
        ...
        for (int i = 0; i < boundry; i++)
        {
            ...
            if(1)
            {
                ...
                ss <<(string)projectpath+ "train/data/plate_detect_svm/train/HasPlate/hasplate_" << i << ".jpg";
                imwrite(ss.str(), img);
            }
        }
        ...
        for (int i = boundry; i < size; i++)
        {
            ...
            {
                stringstream ss(stringstream::in | stringstream::out);
                ss << (string)projectpath+"train/data/plate_detect_svm/test/HasPlate/hasplate_" << i << ".jpg";
                imwrite(ss.str(), img);
            }
        }
    }
    ...
    void learn2NoPlate(float bound = 0.7)
    {
        ...
        string filePath =(string)projectpath+"train/data/plate_detect_svm/learn/NoPlate";
        ...
        for (int i = 0; i < boundry; i++)
        {
            ...
            {
                stringstream ss(stringstream::in | stringstream::out);
                ss << (string)projectpath+"train/data/plate_detect_svm/train/NoPlate/noplate_" << i << ".jpg";
                imwrite(ss.str(), img);
            }
        }
        ...
        for (int i = boundry; i < size; i++)
        {
            ...
            {
                stringstream ss(stringstream::in | stringstream::out);
                ss << (string)projectpath+"train/data/plate_detect_svm/test/NoPlate/noplate_" << i << ".jpg";
                imwrite(ss.str(), img);
            }
        }
    }
    ...
    {
        int label = 1;
        string filePath =(string)projectpath+ "train/data/plate_detect_svm/train/HasPlate";
    ...
    {
        int label = 1;
       string filePath =(string)projectpath+"train/data/plate_detect_svm/test/HasPlate";
    ...
    {
        int label = 0;
       string filePath =(string)projectpath+"train/data/plate_detect_svm/test/NoPlate";
                 ...
                 svmCallback getFeatures = getHistogramFeatures)
    {
        ...
        if (trainPrepared == false && !classes.empty() && !trainingData.empty())
        {
            ...
            FileStorage fsTo((string)projectpath+"train/svm.xml", cv::FileStorage::WRITE);
            svm.write(*fsTo, "svm");
        }
        else
        {
            try {
                string path = (string)projectpath+"train/svm.xml";
