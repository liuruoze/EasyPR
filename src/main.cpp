...
//  EasyPR
//
//  Created by zhoushiwei on 15/4/24.
...
extern const string GENERAL_TEST_PATH = (string)projectpath+"image/general_test";
extern const string NATIVE_TEST_PATH = (string)projectpath+"image/native_test";
